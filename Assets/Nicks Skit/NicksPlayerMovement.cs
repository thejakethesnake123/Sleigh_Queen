...
public class NicksPlayerMovement : MonoBehaviour
{
    // Array of z positions for the lanes
    public float[] lanes = { 634f, 629f, 623f, 618f }; // Define these based on your scene
    private int currentLane = 1; // Start at the second lane (index 1)

    public float moveSpeed = 16f; // Speed of the movement to the lane
